...
class PyTorchConfig(BaseModel):
    ...
    epochs: int = Field(default=500, ge=1, le=2000, description="Number of training epochs")
    ...
    early_stopping_patience: int = Field(default=50, ge=1, le=200, description="Early stopping patience")
